...
public class LanternSwing : MonoBehaviour
{
    [Header("Rotations")]
    [SerializeField]
    private float m_fRotation_Amplitude_Pitch1 = 1;
    [SerializeField]
    private float m_fRotation_Frequency_Pitch1 = 5;
    [Space]
    [SerializeField]
    private float m_fRotation_Amplitude_Roll1 = 1;
    [SerializeField]
    private float m_fRotation_Frequency_Roll1 = 1;
